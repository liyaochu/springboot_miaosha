...
import com.lyc.dao.ItemDOMapper;
import com.lyc.dao.ItemStockDOMapper;
import com.lyc.dao.StockLogDoMapper;
import com.lyc.dataobject.ItemDO;
import com.lyc.dataobject.ItemStockDO;
...
//        }
    ...
    public ItemModel getItemByIdInCache(Integer id) {
        ItemModel itemModel = (ItemModel) redisTemplate.opsForValue().get("item_validate+" + id);
    ...
    @Override
    public boolean ansyDecreaseStock(Integer itemId, Integer amount) {
