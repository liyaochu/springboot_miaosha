...
import com.lyc.dao.OrderDOMapper;
import com.lyc.dao.SequenceDOMapper;
import com.lyc.dao.StockLogDoMapper;
import com.lyc.dataobject.OrderDO;
import com.lyc.dataobject.SequenceDO;
...
//        }
        ...
        //异步更新库存
        boolean mqResult = itemService.ansyDecreaseStock(itemId, amount);
        if (!mqResult) {
